...
namespace AsitLib.SpellScript
{
    ...
    {
        /// <summary>
        /// Base of most <see cref="SpellUtils"/> methods. Made public because it may be usefull.
        /// </summary>
        ...
        public static SpellCommand AsSpellCommand(this string s, object[]? lineMemory, object[]? funcMemory) => new SpellCommand(s, lineMemory: lineMemory, funcMemory: funcMemory);
    }
}
