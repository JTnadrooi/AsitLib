...
namespace AsitLib.Collections
{
    ...
    public class SegmentedMap<T> : ISegmentedMap<T>
    {
        ...
        public SegmentedMap(T[] source) : this(AsitLib.ArrayHelpers.ToKeyValuePair(source)) { }
        public SegmentedMap(T[] source, int capacity) : this(AsitLib.ArrayHelpers.ToKeyValuePair(source), capacity) { }
