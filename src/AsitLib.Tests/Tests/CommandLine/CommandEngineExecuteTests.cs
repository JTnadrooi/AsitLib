...
namespace AsitLib.Tests
{
	...
	public class CommandEngineExecuteTests
	{
		...
		{
			Invoking(() => Engine.Execute("print hi true doest-exist")).Should().ThrowExactly<CommandException>();
		}
		...
		{
			Invoking(() => Engine.Execute("validation 11")).Should().ThrowExactly<CommandException>();
		}
